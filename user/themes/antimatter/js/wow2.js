...
(function() {
    ...
    b = function() {
        ...
        return e.prototype.defaults = { boxClass: "wow2", animateClass: "animated", offset: 0, mobile: !0, live: !0, callback: null, scrollContainer: null }, e.prototype.init = function() {
            var a;
            ...
            var b, c, d, e, f;
            return c = a.getAttribute("data-wow2-offset") || this.config.offset, f = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset, e = f + Math.min(this.element.clientHeight, this.util().innerHeight()) - c, d = this.offsetTop(a), b = d + a.clientHeight, e >= d && b >= f }, e.prototype.util = function() {
